...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'WebRSSource', fields ['source_code']
        db.create_unique('lizard_fewsjdbc_webrssource', ['source_code'])


    def backwards(self, orm):
        # Removing unique constraint on 'WebRSSource', fields ['source_code']
        db.delete_unique('lizard_fewsjdbc_webrssource', ['source_code'])
