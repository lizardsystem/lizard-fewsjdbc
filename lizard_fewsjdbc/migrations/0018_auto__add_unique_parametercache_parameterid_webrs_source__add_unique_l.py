...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ParameterCache', fields ['parameterid', 'webrs_source']
        db.create_unique('lizard_fewsjdbc_parametercache', ['parameterid', 'webrs_source_id'])

        # Adding unique constraint on 'LocationCache', fields ['locationid', 'webrs_source']
        db.create_unique('lizard_fewsjdbc_locationcache', ['locationid', 'webrs_source_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'LocationCache', fields ['locationid', 'webrs_source']
        db.delete_unique('lizard_fewsjdbc_locationcache', ['locationid', 'webrs_source_id'])

        # Removing unique constraint on 'ParameterCache', fields ['parameterid', 'webrs_source']
        db.delete_unique('lizard_fewsjdbc_parametercache', ['parameterid', 'webrs_source_id'])
    ...
    models = {
        ...
        'lizard_fewsjdbc.locationcache': {
            'Meta': {'unique_together': "(('locationid', 'webrs_source'),)", 'object_name': 'LocationCache'},
        ...
        'lizard_fewsjdbc.parametercache': {
            'Meta': {'unique_together': "(('parameterid', 'webrs_source'),)", 'object_name': 'ParameterCache'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
