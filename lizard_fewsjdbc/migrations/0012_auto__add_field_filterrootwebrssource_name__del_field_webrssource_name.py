...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FilterRootWebRSSource.name'
        db.add_column('lizard_fewsjdbc_filterrootwebrssource', 'name',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2013, 9, 2, 0, 0), max_length=50),
                      keep_default=False)

        # Deleting field 'WebRSSource.name'
        db.delete_column('lizard_fewsjdbc_webrssource', 'name')


    def backwards(self, orm):
        # Deleting field 'FilterRootWebRSSource.name'
        db.delete_column('lizard_fewsjdbc_filterrootwebrssource', 'name')

        # Adding field 'WebRSSource.name'
        db.add_column('lizard_fewsjdbc_webrssource', 'name',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2013, 9, 2, 0, 0), max_length=50),
                      keep_default=False)
