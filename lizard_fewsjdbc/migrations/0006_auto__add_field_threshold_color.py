...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Threshold.color'
        db.add_column('lizard_fewsjdbc_threshold', 'color',
                      self.gf('django.db.models.fields.CharField')(default='000000', max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Threshold.color'
        db.delete_column('lizard_fewsjdbc_threshold', 'color')
