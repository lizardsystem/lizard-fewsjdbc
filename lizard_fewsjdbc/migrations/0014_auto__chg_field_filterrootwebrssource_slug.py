...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FilterRootWebRSSource.slug'
        db.alter_column('lizard_fewsjdbc_filterrootwebrssource', 'slug', self.gf('django.db.models.fields.SlugField')(default=datetime.datetime(2013, 9, 2, 0, 0), unique=True, max_length=50))

    def backwards(self, orm):

        # Changing field 'FilterRootWebRSSource.slug'
        db.alter_column('lizard_fewsjdbc_filterrootwebrssource', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50, null=True))
    ...
    models = {
        ...
        'lizard_fewsjdbc.filterrootwebrssource': {
            ...
            'filter_tree_root': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True'}),
