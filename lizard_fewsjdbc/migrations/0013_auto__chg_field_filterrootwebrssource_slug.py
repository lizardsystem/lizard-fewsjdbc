...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('lizard_fewsjdbc_filterrootwebrssource', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'FilterRootWebRSSource.slug'
        db.alter_column('lizard_fewsjdbc_filterrootwebrssource', 'slug', self.gf('django.db.models.fields.SlugField')(default=datetime.datetime(2013, 9, 2, 0, 0), max_length=50, unique=True))
