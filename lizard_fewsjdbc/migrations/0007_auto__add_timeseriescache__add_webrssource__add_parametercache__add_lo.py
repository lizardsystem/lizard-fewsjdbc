...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_fewsjdbc_webrssource', (
            ...
            ('base_path', self.gf('django.db.models.fields.URLField')(max_length=250)),
        ))
        ...
        db.create_table('lizard_fewsjdbc_parametercache', (
            ...
            ('parameter_group', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        ...
        db.create_table('lizard_fewsjdbc_locationcache', (
            ('locationid', self.gf('django.db.models.fields.CharField')(max_length=50, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('short_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ...
            ('parent_id', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal('lizard_fewsjdbc', ['LocationCache'])

        # Adding model 'FilterCache'
        db.create_table('lizard_fewsjdbc_filtercache', (
            ('filterid', self.gf('django.db.models.fields.CharField')(max_length=50, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ...
            ('parent_id', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('parent_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
    ...
    models = {
        'lizard_fewsjdbc.filtercache': {
            ...
            'filterid': ('django.db.models.fields.CharField', [], {'max_length': '50', 'primary_key': 'True'}),
            ...
            'parent_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'})
        },
        ...
        'lizard_fewsjdbc.locationcache': {
            ...
            'locationid': ('django.db.models.fields.CharField', [], {'max_length': '50', 'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'parent_id': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        'lizard_fewsjdbc.parametercache': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'parameter_group': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        'lizard_fewsjdbc.webrssource': {
            ...
            'base_path': ('django.db.models.fields.URLField', [], {'max_length': '250'}),
